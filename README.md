...
A token is used to verify credentials and allows a user to gain access to protected routes.

- [ ] What steps can you take in your web apps to keep your data secure?

Using tokens in combination with Private Routes can help keep data secure.

- [ ] Describe how web servers work.

When a user enters a url link in a web browser their computer sends a request to a server and the server then sends the data back to the user's computer and displayes a web page.
